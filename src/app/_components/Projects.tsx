    ...
    <div className="col-span-full">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <Card
          ...
          onClick={() =>
            posthog.capture("project_clicked", { name: "meetingbot" })
          }
        >
          <CardHeader>
        ...
        <Card
          ...
          onClick={() => posthog.capture("project_clicked", { name: "dash" })}
        >
          <CardHeader>
        ...
        <Card
          ...
          onClick={() =>
            posthog.capture("project_clicked", { name: "deltahacks_portal" })
          }
        >
          <CardHeader>
        ...
        <Card
          href="https://www.salesbop.io"
          onClick={() =>
            posthog.capture("project_clicked", { name: "salesbop" })
          }
        >
          <CardHeader>
        ...
        <Card
          ...
          onClick={() =>
            posthog.capture("project_clicked", { name: "personal_site" })
          }
        >
          <CardHeader>
        ...
        <Card
          ...
          onClick={() =>
            posthog.capture("project_clicked", { name: "mcmaster_cs_wiki" })
          }
        >
          <CardHeader>
